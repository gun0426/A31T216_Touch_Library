...
static void mainloop(void)
{
    ...
    LOG("main clock output enable\n");
    HAL_SCU_EnableClockOut(4);	// Clock output = main clock / 10
...
int main(void)
{
    ...
    LOG("\t %s, %s\n", __DATE__, __TIME__);
    LOG("\t Clock Setting - CLKO Function Setting, Check PORT Setting (PD0) - MLCK(8Mhz)/10\n");
    LOG("************************************************\n");
